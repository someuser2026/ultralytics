...
OBB_EXTRA=",ANGLE_MODE=le90,CLAHE_P=0.10,MOTION_BLUR_P=0.0,MULTI_SPEC_NOISE_P=0.10,UNSHARP_P=0.0,GAUSSIAN_BLUR_P=0.0"
SEG_EXTRA=",CLAHE_P=0.0,MOTION_BLUR_P=0.20,MULTI_SPEC_NOISE_P=0.10,UNSHARP_P=0.10,SDICE=1,GAUSSIAN_BLUR_P=0.20"
