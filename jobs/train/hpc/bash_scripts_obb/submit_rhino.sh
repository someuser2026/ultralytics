...
usage() {
  cat <<'EOF'
Usage:
  bash jobs/train/hpc/bash_scripts_obb/submit_rhino.sh [MODEL_OR_CONFIG] [IMGSZ] [BATCH] [MULTISPECTRAL_OPT] [DRY_RUN]

Examples:
  bash jobs/train/hpc/bash_scripts_obb/submit_rhino.sh
  bash jobs/train/hpc/bash_scripts_obb/submit_rhino.sh rhino-r50-obb 448 4 pn10075s 1
  bash jobs/train/hpc/bash_scripts_obb/submit_rhino.sh rhino-dinov3-augfpn-obb 448 4 pn10075s 0
  bash jobs/train/hpc/bash_scripts_obb/submit_rhino.sh ultralytics/cfg/models/rhino/rhino-r50-obb.yaml 448 4 21 0

Supported aliases:
  rhino-r50-obb
  rhino_r50_obb
  rhino-dinov3-augfpn-obb
  rhino_dinov3_augfpn_obb
...
MODEL_OR_CONFIG="${1:-rhino-r50-obb}"
IMGSZ="${2:-448}"
BATCH="${3:-4}"
...
resolve_config() {
  ...
  case "$model_or_config" in
    rhino-r50-obb|rhino-r50-obb.yaml|rhino_r50_obb|rhino_r50_obb.yaml)
      printf 'ultralytics/cfg/models/rhino/rhino-r50-obb.yaml\n'
      return 0
      ;;
    rhino-dinov3-augfpn-obb|rhino-dinov3-augfpn-obb.yaml|rhino_dinov3_augfpn_obb|rhino_dinov3_augfpn_obb.yaml)
      printf 'ultralytics/cfg/models/rhino/rhino-dinov3-augfpn-obb.yaml\n'
      return 0
      ;;
  esac
