...
# Common env (task/config family stays segment_no_drop; tweak if you switch task)
...
seg_cfg() {
  timm_segment_final_panet_config "$1" no_drop 1cls
}
...
JOBS=(
  ...
  "resnet50_rgb_1234_no_drop|resnet50|0"
  "resnext50_32x4d_rgb_1234_no_drop|resnext50_32x4d|0"
  "seresnet50_rgb_1234_no_drop|seresnet50|0"

  # CNN BACKBONES — EfficientNet family
  "efficientnet_b1_rgb_1234_no_drop|efficientnet_b1|0"
  "efficientnetv2_s_rgb_1234_no_drop|efficientnetv2_s|0"
  ...
  "convnext_small_rgb_1234_no_drop|convnext_small|0"
  "convnext_base_rgb_1234_no_drop|convnext_base|0"

  # CNN BACKBONES — RegNet family
  "regnety_040_rgb_1234_no_drop|regnety_040|0"

  # CNN BACKBONES — MobileNet family

  # CNN BACKBONES — DenseNet family
  "densenet121_rgb_1234_no_drop|densenet121|0"

  # CNN BACKBONES — HRNet family
  "hrnet_w32_rgb_1234_no_drop|hrnet_w32|0"

  # VISION TRANSFORMERS — Swin family
  "swin_tiny_rgb_1234_no_drop|swin_tiny_patch4_window7_224|0"

  # VISION TRANSFORMERS — PVT family
  "pvt_tiny_rgb_1234_no_drop|pvt_tiny|0"

  # VISION TRANSFORMERS — DeiT family
  "deit_small_rgb_1234_no_drop|deit_small_p16_224|0"

  # VISION TRANSFORMERS — BEiT family

  # VISION TRANSFORMERS — MaxViT family
  "maxvit_small_rgb_1234_no_drop|maxvit_small|0"

  # VISION TRANSFORMERS — EfficientViT family

  # VISION TRANSFORMERS — MobileViT family
  "mobilevit_s_rgb_1234_no_drop|mobilevit_s|0"

  # HYBRID — CoAtNet family
  "coatnet_0_rgb_1234_no_drop|coatnet_0|0"

  # FOUNDATION — DINOv3 (frozen backbone)
  "dinov3_vitb14_rgb_1234_no_drop|dinov3_vitb14|1"
)
