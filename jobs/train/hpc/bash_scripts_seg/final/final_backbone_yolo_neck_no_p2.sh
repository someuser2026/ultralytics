...
seg_yolo_cfg() {
  timm_segment_final_yolo_neck_config "$1" "$2" "${CLS_TAG}" flat_no_p2
}
...
JOBS=(
  ...
  "hrnet_w18_rgb_yolo_neck_no_p2|hrnet_w18|panet_adaptive|0"
  "hrnet_w32_rgb_yolo11_neck_no_p2|hrnet_w32|yolo11x|0"
  "hrnet_w32_rgb_yolo12_neck_no_p2|hrnet_w32|yolo12x|0"
  ...
  "dinov3_vitb14_rgb_yolo11_neck_no_p2|dinov3_vitb14|yolo11x|1"
  "dinov3_vitb14_rgb_yolo12_neck_no_p2|dinov3_vitb14|yolo12x|1"
)
...
for job in "${JOBS[@]}"; do
  ...
  if [[ "${head}" == "panet_adaptive" ]]; then
    config_yaml="$(timm_segment_final_panet_config "${model}" no_p2 1cls)"
  else
