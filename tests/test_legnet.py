...
LEGNET_MODELS = {
    "legnet-small.yaml": "Detect",
    "legnet-small-seg.yaml": "Segment",
    "legnet-small-obb.yaml": "OBB",
}
...
@pytest.mark.parametrize(("model_name", "head_name"), LEGNET_MODELS.items())
def test_legnet_model_yaml_parses(model_name, head_name):
