...
MODELS = ("YOLO", "YOLOWorld", "YOLOE", "NAS", "SAM", "FastSAM", "RTDETR", "CascadeRCNN")
...
if TYPE_CHECKING:
    ...
    from ultralytics.models import CascadeRCNN, FastSAM, NAS, RTDETR, SAM, YOLO, YOLOE, YOLOWorld  # noqa
