...
MODELS = ("YOLO", "YOLOWorld", "YOLOE", "NAS", "SAM", "FastSAM", "RTDETR", "RCNN", "RHINO")#, "CascadeRCNN")
...
if TYPE_CHECKING:
    ...
    from ultralytics.models import YOLO, YOLOWorld, YOLOE, NAS, SAM, FastSAM, RTDETR, RCNN, RHINO  # noqa
