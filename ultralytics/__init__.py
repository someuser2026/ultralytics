...
MODELS = ("YOLO", "YOLOWorld", "YOLOE", "NAS", "SAM", "FastSAM", "RTDETR", "RCNN", "RHINO", "Mask2Former")#, "CascadeRCNN")
...
if TYPE_CHECKING:
    ...
    from ultralytics.models import YOLO, YOLOWorld, YOLOE, NAS, SAM, FastSAM, RTDETR, RCNN, RHINO, Mask2Former  # noqa
